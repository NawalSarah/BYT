...
public class AccountTest {
    ...
    public void setUp() throws Exception {
        ...
        SweBank.openAccount("Amanda");
        testAccount = new Account("Sarah", SEK);
        testAccount.deposit(new Money(10000000, SEK));

        SweBank.deposit("Amanda", new Money(1000000, SEK));
    }
    ...
    public void testAddRemoveTimedPayment() {
        testAccount.addTimedPayment("1", 10, 10, new Money(100, SEK), SweBank, "Amanda");
        testAccount.addTimedPayment("1", 10, 10, new Money(100, SEK), SweBank, "Amanda");
    ...
    public void testTimedPayment() throws AccountDoesNotExistException {
        testAccount.addTimedPayment("1", 2, 0, new Money(10000, SEK), SweBank, "Amanda");
        for (int i = 0; i < 10; i++) {
            testAccount.tick();
        }
